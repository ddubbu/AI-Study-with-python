...
def isBetween(toCheck, oragne, melon):
...
def main():
    ...
    for case in range(total_case):
        ...
        # 또한, 체크할 아이가 orange와 melon 사이에 있어야함.
            ...
            if (pos_orange[1] - pos_melon[1]) == 0:  # y 좌표값만 비교해서 사이에 있는 값이 있는지 체크
                for person in wait_line:
                    if person == pos_orange or person == pos_melon:
                        continue
                    # else
                    if pos_orange[2] < person[2] and person[2] < pos_melon[2]:
                        canSee = 0
                        print("case1")
                        break
                ...
                for person in wait_line:
                    if person == pos_orange or person == pos_melon:
                        continue
                    # else
                    if pos_orange[1] <= person[1] and person[1] <= pos_melon[1] and pos_orange[2] <= person[2] and person[2] <= pos_melon[2]:
