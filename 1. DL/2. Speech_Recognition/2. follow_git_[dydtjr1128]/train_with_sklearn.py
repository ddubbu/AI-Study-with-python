'''
reference
https://colab.research.google.com/github/dydtjr1128/Speaker-Recognition-using-NN/blob/master/%ED%99%94%EC%9E%90%EC%9D%B8%EC%8B%9D.ipynb
'''
...
DATA_PATH = "./data/train/"  # ★ data 위치 바꿈
...
y, sr = librosa.load("./data/test/test_유인나1.wav")  # ★ data 위치 바꿈
